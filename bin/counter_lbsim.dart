  ...
  while (!stop) {
    ...
    switch (choice) {
      case 0:
        ...
        break;
      case 1:
        print('Enter the value by which you want to increment count : ');
        ...
        break;
      case 2:
        print('Enter the value by which you want to decrement count : ');
        operationValue = int.parse(stdin.readLineSync()!);
        ...
        break;
      case 3:
        print('Enter the value by which you want to multiply count with: ');
        operationValue = int.parse(stdin.readLineSync()!);
        ...
        break;
      case 4:
        print('Enter the value by which you want to divide count with: ');
        operationValue = int.parse(stdin.readLineSync()!);
      ...
      case 5:
        print(
            'Enter the value by which you want to check remainder of count with: ');
        operationValue = int.parse(stdin.readLineSync()!);
